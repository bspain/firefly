...
@then(
    'the financial calculation service raises a ValueError with message "Present value cannot be negative"'
)
@then(
    'the financial calculation service raises a ValueError with message "Number of periods cannot be negative"'
)
